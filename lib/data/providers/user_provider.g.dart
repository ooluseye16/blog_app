...
String _$userRepositoryHash() => r'43c2e27caf6cd89eb1c576bd72298116504e34c3';

/// See also [userRepository].
@ProviderFor(userRepository)
final userRepositoryProvider = Provider<UserService>.internal(
  userRepository,
...
typedef UserRepositoryRef = ProviderRef<UserService>;
String _$userHash() => r'ba31b8f0745cb174f4e9a495631321ce8acdeedb';
...
String _$userByIdHash() => r'52e0d915fd2c3bc5a2998be1772cb68ad2b6ad48';
...
/// See also [userById].
class UserByIdProvider extends FutureProvider<User?> {
  /// See also [userById].
  UserByIdProvider(
    String id,
  ) : this._internal(
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin UserByIdRef on FutureProviderRef<User?> {
  /// The parameter `id` of this provider.
  String get id;
}

class _UserByIdProviderElement extends FutureProviderElement<User?>
    with UserByIdRef {
